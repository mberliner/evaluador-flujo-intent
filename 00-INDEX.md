...
6. [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) — workflow, commits y code review
7. [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) — setup local y comandos clave
8. [docs/PRODUCT.md](docs/PRODUCT.md) — producto y métricas
