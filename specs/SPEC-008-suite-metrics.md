...
| FR-010 | caso de uso `generate_metrics_report` en `src/application/generate_metrics_report.py`; llamado desde `_render_run_stats_control` en `src/dashboard/app.py` y desde `_report_total_metrics` en `src/runner.py` |
