...
| SPEC-013-client-adapter-selection | Selección de adaptador de cliente para plataformas alternativas | active | 13 impl.2026-07-03 (US1, US2, US3 cerradas) | híbrido | [SPEC-013-client-adapter-selection.md](SPEC-013-client-adapter-selection.md) |
